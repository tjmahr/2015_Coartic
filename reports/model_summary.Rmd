...
(`r pretty_chi_result(cdi_anova1, "MODEL2")`), 
nor did vocabulary size interact with the condition effect 
(`r pretty_chi_result(cdi_anova2, "MODEL2")`). There was also no effect of age 
on the intercept term (`r pretty_chi_result(age_anova1, "MODEL2")`) or on the 
condition term (`r pretty_chi_result(age_anova2, "MODEL2")`). Model fit did not 
